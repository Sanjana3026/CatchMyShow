...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/src/assets/backgroundImage.png")] bg-cover bg-center h-screen'>
      ...
      <p className = 'max-w-md text-gray-300'>A talking raccoon and his tree bestie lead a bunch of cosmic losers to accidentally save the universe while rocking a killer '70s playlist.</p>

...
const AddShows = () => {
  ...
  return nowPlayingMovies.length >0 ? (
    ...
    <div className='mt-8'>
      ...
      <div className='inline-flex items-center gap-2 border border-gray-600 px-3 rounded-md '>
    ...
    <button className='bg-primary text-white px-8 py-2 mt-6 rounded hoveer:bg-primary/90 transition-all cursor-pointer'>Add Show</button>
    </>
  ) : <Loading />
}

      ...
      {bookings.map((item,index)=>(
        <div key={index} className='flex flex-col md:flex-row justify-between bg-primary/8 border border-primary/20 rounded-lg mt-4 p-2 max-w-3xl'>
          <div className='flex flex-col md:flex-row'>
            <img src={img_base_url + item.show.movie.poster_path} alt="image" className='md:max-w-45 aspect-video h-auto object-cover object-bottom rounded-lg'/>
          ...
          <div className='flex flex-col md:items-end md:text-right justify-between p-4'>
            ...
            <div className='text-sm'>
              <p><span className='text-gray-400'>Total Tickects : </span> {item.bookedSeats.length}</p>

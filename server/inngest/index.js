...
const releaseSeatsAndDeleteBooking = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run('check-payment-status', async()=>{
            ...
            console.log("Show ID from booking:", booking.show);
  ...
  async ({ event, step }) => {
    ...
    const booking = await Booking.findById(bookingId)
      ...
      body: `<div style="font-family: Arial, sans-serif; line-height: 1.5;">
        ...
        <p>Enjoy the show! 🍿</p>
        <p>Thanks for booking with us!<br />- CatchMyShow Team</P>
      </div>`,
    });
  }
);
  ...
  async ({ step }) => {
    ...
    const results = await step.run("send-all-reminders", async () => {
      return await Promise.allSettled(
        ...
        <br />
        <p>Enjoy the show! 🍿 - CatchMyShow Team</P>
      </div>`,
          })
        )
      );
  ...
  async ({ event }) => {
    ...
    for (const user of users) {
      ...
      const body = `<div style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        <p>Visit our website - <a href="https://quickshow-sigma-roan.vercel.app/">CatchMyShow</a> 🔗</p>
        <br />
        <p>Thanks, <br />CatchMyShow Team</p>
      </div>`;
